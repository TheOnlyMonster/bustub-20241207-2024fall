...
class BPlusTreeInternalPage : public BPlusTreePage {
 public:
  ...
  auto Split(BPlusTreeInternalPage *sibling, KeyType *middle_key) -> void;

  auto Remove(int index) -> void;

  auto Merge(BPlusTreeInternalPage *sibling) -> void;

  auto RemoveAndDeleteRecord(const KeyType &key, const KeyComparator &comparator) -> bool;

  auto InsertFront(const KeyType &new_key, const ValueType &new_value) -> void;

  auto InsertBack(const KeyType &new_key, const ValueType &new_value) -> void;
